...
| Candidate verification | Pass in the canonical repository suite | `scripts/verify-examples.sh`: 743 tests, 11/11 conformance checks, and all bundled audits pass; same-commit CI remains a separate publication gate |
